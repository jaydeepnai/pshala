...
export default async function DropDown({ type, Navigation, ApiEndPoint }) {
    ...
    var url = process.env.REACT_APP_EventFunctionAppBaseAddress + "api/" + ApiEndPoint + "?entityName=" + type;
    var result;
